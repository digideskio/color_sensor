...
int ledPin = 12;  // LED light source pin, any unused pin will work
...
void loop()
{
  ...
  {  // if l is pressed, output color readings to an RGB LED
    ...
    {  // Run continuously, until a key is pressed
      ...
      Serial.println();
      Serial.println("Printing Color!!!!");
      colorWipe(Color(averageData[0],averageData[1],averageData[2]));
    }
...
int calibrateClear()
{
  ...
  Serial.println("Calibrating: clear.");
...
{
  Serial.println("Calibrating: capacitors.");
